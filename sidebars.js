  ...
  sidebar: [
    ...
    // 6. Computer Organization & Architecture
    {
      ...
      items: [
        ...
        "computer-organization-and-architecture/other-processing-units/other-processing-units",
      ],
    },
    ...
    // 9. Compilers & Programming Languages
    {
      ...
      items: [
        "compilers-and-programming-languages/cpl-fundamentals/cpl-fundamentals",
        {
          ...
          items: [
            "compilers-and-programming-languages/syntax/syntax",
            "compilers-and-programming-languages/scanning/scanning",
            "compilers-and-programming-languages/parsing/parsing",
            "compilers-and-programming-languages/semantic-analysis/semantic-analysis",
          ],
        },
        {
          type: "category",
          ...
          items: [
            "compilers-and-programming-languages/names-scopes-bindings/names-scopes-bindings",
            "compilers-and-programming-languages/control-flow/control-flow",
            "compilers-and-programming-languages/data-types/data-types",
            "compilers-and-programming-languages/subroutines/subroutines",
            "compilers-and-programming-languages/data-abstraction/data-abstraction",
          ],
        },
        {
          type: "category",
          ...
          items: [
            "compilers-and-programming-languages/target-architecture/target-architecture",
        ...
        },
        {
          ...
          items: [
            ...
            "compilers-and-programming-languages/scripting-languages/scripting-languages",
          ],
        },
      ],
    },
    ...
    // 13. Backend System
    {
      ...
      items: [
        "backend-system/web-server/web-server",
        {
          ...
          label: "APIs",
          items: [
            "backend-system/apis-server-logic/apis-server-logic",
            "backend-system/rest-api/rest-api",
            "backend-system/soap/soap",
            "backend-system/graphql/graphql",
            "backend-system/rpc/rpc",
            "backend-system/webhook/webhook",
            "backend-system/websocket/websocket",
          ],
        },
        ...
        "backend-system/message-broker/message-broker",
        {
          ...
          label: "Architecture",
          items: [
            "backend-system/monolithic/monolithic",
            "backend-system/microservice/microservice",
            "backend-system/soa/soa",
