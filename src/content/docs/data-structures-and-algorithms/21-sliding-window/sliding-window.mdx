...
**Sliding Window** is a technique to solve problems similar to the [two pointer technique](/cs-notes/data-structures-and-algorithms/two-pointer), with addition, sliding window also takes account whatever element inside the left and right pointer.
