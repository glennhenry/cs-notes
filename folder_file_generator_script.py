...
# May not work for some title with uppercase abbreviation e.g. HTML CSS

import os

topic_title = "digital-signal-processing"
...
def generate_topic_links():
    for i, kebab_title in enumerate(content, start=1):
...
def generate_folder_file():
    ...
    print("Project structure and MDX files created successfully!")
